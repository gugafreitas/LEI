...
public class Utilizador implements Serializable{
    ...
    public boolean equals(Object o) {
        ...
        return passwordHash == that.passwordHash && notificacao == that.notificacao && Double.compare(that.raio, raio) == 0 && Objects.equals(id, that.id) && Objects.equals(name, that.name) && Objects.equals(coordenada, that.coordenada);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, passwordHash, coordenada, notificacao, raio);
    }
